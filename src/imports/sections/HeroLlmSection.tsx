...
export default function HeroLlmSection() {
  ...
  return (
    <section id="hero" className="relative w-full overflow-hidden bg-[#051a30]">
      <img
        src={imgHero}
        alt=""
        aria-hidden="true"
...
<div className="absolute inset-0 bg-gradient-to-r from-[#000]/95 via-[#000]/80 to-[#000]/55" />
      ...
      <div className="relative z-10 px-4 sm:px-8 md:px-[75px] min-h-screen flex items-center">
        <div className="max-w-[1366px] mx-auto w-full">
          <div className="grid gap-10 md:gap-16 md:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)] items-center">
            ...
            <div className="flex flex-col gap-7">
              ...
              <h1 className="font-['Inter',sans-serif] font-bold text-[42px] md:text-[42px] lg:text-[70px] leading-[1.08] text-[#f9f9f9] tracking-tight">
              ...
              <div className="flex flex-wrap gap-6 sm:gap-10 mt-2">
                <div className="flex items-center gap-3">
                  <img src={imgCalendar} alt="" aria-hidden="true" className="w-[28px] h-[28px] shrink-0 object-contain" />
                  <div>
                    <p className="font-['Inter',sans-serif] font-normal text-[11px] text-white uppercase tracking-widest leading-none mb-1">DATA</p>
                    <p className="font-['Inter',sans-serif] font-semibold text-[15px] text-[#f9f9f9]">23 de abril</p>
                  </div>
                </div>

                <div className="flex items-center gap-3">
                  <img src={imgTimer} alt="" aria-hidden="true" className="w-[28px] h-[28px] shrink-0 object-contain" />
                  <div>
                    <p className="font-['Inter',sans-serif] font-normal text-[11px] text-white uppercase tracking-widest leading-none mb-1">HORÁRIO</p>
                    <p className="font-['Inter',sans-serif] font-semibold text-[15px] text-[#f9f9f9]">10:00 (Brasília)</p>
                  </div>
                </div>

                <div className="flex items-center gap-3">
                  <img src={imgVideo} alt="" aria-hidden="true" className="w-[28px] h-[28px] shrink-0 object-contain" />
                  <div>
                    <p className="font-['Inter',sans-serif] font-normal text-[11px] text-white uppercase tracking-widest leading-none mb-1">PLATAFORMA</p>
                    <p className="font-['Inter',sans-serif] font-semibold text-[15px] text-[#f9f9f9]">YouTube</p>
                  </div>
                </div>
              </div>
            </div>

            <div id="form-llm" className="bg-[#f9f9f9] p-7 sm:p-9 shadow-2xl w-full">
              <h3 className="font-['Inter',sans-serif] text-center font-bold text-[22px] sm:text-[24px] text-[#051a30] mb-6">
              ...
              {!submitted ? (
                <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-[#d92b8a] hover:bg-[#c0246a] active:bg-[#a81e5b] text-[#f9f9f9] font-['Inter',sans-serif] font-bold text-[16px] py-3.5 transition-colors mt-2"
                  >
                ...
                <div className="text-center py-10">
                  ...
                  <p className="font-['Inter',sans-serif] font-bold text-[18px] text-[#051a30] mb-2">Inscrição realizada!</p>
